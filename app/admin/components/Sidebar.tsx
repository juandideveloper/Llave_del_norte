...
export default function Sidebar({ aprobacionesPendientes = 0 }: SidebarProps) {
  ...
  const links: NavGroup[] = [
    ...
    },
    {
      grupo: "MARKETING",
      items: [
        { href: "/admin/suscripciones", label: "Suscriptores", icon: "bell" },
      ],
    },
  ];

  return (
    <aside className="w-52 min-h-screen bg-verde flex-shrink-0 flex flex-col">
      ...
      <nav className="p-3 space-y-5 mt-2 flex-1">
        {links.map((grupo, gi) => (
          <div key={gi}>
      ...
      <div className="p-3 border-t border-white/10">
        <button
          ...
          className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm text-white/60 hover:text-red-400 hover:bg-white/5 transition-colors w-full cursor-pointer">
