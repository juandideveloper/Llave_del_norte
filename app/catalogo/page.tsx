    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex gap-6 px-4 md:px-6 py-6 max-w-7xl mx-auto">
        ...
        <div className="flex-1 space-y-6 min-w-0">
          ...
          {/* Productos */}
          <div>
            <h2 className="text-xl font-semibold text-verde/46 uppercase tracking-widest text-center mb-4">{categoriaActiva}</h2>
                  ...
                  {productosPaginados.map((producto) => {
                    ...
                    return (
                      <motion.div key={producto.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
                        ...
                        className="bg-gray-200/50 rounded-xl overflow-hidden border-1 border-amarillo">
