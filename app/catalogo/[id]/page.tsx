...
export default function DetalleProductoPage() {
  ...
  useEffect(() => {
    if (sliderRelacionadosRef.current) {
      setCardWidthRelacionados(
        sliderRelacionadosRef.current.offsetWidth / 4 - 12,
      );
    }
  }, [relacionados]);
  ...
  const precio =
    producto.price[0]?.precioConIva ?? producto.price[0]?.price ?? 0; // <-- con IVA
          ...
          <div className="bg-gray-100 border-gray-400 border-2 rounded-t-lg pt-4 px-4 md:pl-7 md:pr-7">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm text-gray-400">
                {promedioResenas.toFixed(1)} ({resenas.length})
              </span>
            </div>
            {esEspecial ? (
              <div className="mb-4">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-lg text-sm font-medium bg-amarillo text-verde hover:opacity-90 cursor-pointer transition-all"
                >
                  Comprar ahora
                </button>
              </div>
            </div>
            <div className="flex items-center gap-2 text-sm text-verde bg-amarillo/10 rounded-lg p-3 border border-amarillo">
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
              ...
              <span className="text-amarillo-oscuro font-medium">
                Para evitar problemas al momento de instalación, lee la
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 mt-4">
            ...
            <div className="md:ml-auto flex items-start">
              {session ? (
                <button
                  onClick={() => setMostrarFormResena(!mostrarFormResena)}
