  ...
  return (
    <div className="min-h-screen bg-hueso">
      ...
      >
        ...
        {/* Logo decorativo - oculto en móvil */}
        <motion.div
      ...
      <section id="catalogo" className="px-4 md:px-8 py-10 md:py-14 bg-verde">
        ...
        <div className="grid grid-cols-2 gap-2 max-w-4xl mx-auto">
          <Link
            href="/catalogo?categoria=griferia-bano"
         ...
         >
          ...
          <div className="grid grid-cols-2 gap-2">
            {categorias.slice(1).map((cat, i) => (
              <Link
                key={i}
                href={`/catalogo?categoria=${cat.nombre.toLowerCase().replace(/ /g, "-")}`}
                className="relative rounded-lg overflow-hidden bg-verde-claro aspect-square cursor-pointer group"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <p className="text-base md:text-lg text-verde/90 leading-relaxed mb-8">
              ...
              clientes superen cualquier barrera. No somos solo una solución;
              somos el punto de partida hacia tu próximo gran objetivo.
            </p>
      ...
      <footer id="contacto" className="bg-verde px-4 md:px-8 py-10 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1px_1fr_1px_1fr] gap-6 mb-8 items-start">
          {/* Columna 1 - Info */}
          <div>
            <LogoSVG fill="#C5973D" width="70pt" height="70pt" />
          ...
          {/* Separador horizontal en móvil y tablet, vertical en desktop */}
          <div className="lg:hidden col-span-1 sm:col-span-2 border-t border-white/20" />
          <div className="hidden lg:block w-px bg-white/20 self-stretch" />

          {/* Columna 3 - Suscripción — siempre visible */}
