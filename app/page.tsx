...
const categorias = [
  { nombre: "Lavaplatos", productos: 19, image: "/images/CatalogoLavabos.png" },
  {
    nombre: "Grifería de baño",
    productos: 60,
    image: "/images/CatalogoBaño.png",
  },
  ...
  { nombre: "Cocina", productos: 50, image: "/images/CatalogoCocina.png" },
  {
    nombre: "Accesorios",
    productos: 80,
    image: "/images/CatalogoAccesorios.png",
  },
];
...
const chips = [
  {
    nombre: "Grifería",
    href: `/catalogo?categoria=${encodeURIComponent("Grifería")}`,
  },
  {
    nombre: "Lavaplatos",
    href: `/catalogo?categoria=${encodeURIComponent("Lavaplatos")}`,
  },
  {
    nombre: "Duchas",
    href: `/catalogo?categoria=${encodeURIComponent("Duchas")}`,
  },
  {
    nombre: "Válvulas",
    href: `/catalogo?categoria=${encodeURIComponent("Válvulas")}`,
  },
  {
    nombre: "Accesorios",
    href: `/catalogo?categoria=${encodeURIComponent("Accesorios")}`,
  },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    fetch("/api/productos")
      ...
      .then((data) => {
        if (data.productos) {
          const filtrados = data.productos.filter((p: ProductoAlegra) =>
            p.customFields?.some(
              (f: { name: string; value: string }) =>
                f.name === "Destacados" && f.value === "Si",
            ),
          );
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setSliderActual((prev) =>
        prev === destacados.length - 1 ? 0 : prev + 1,
      );
    }, 4000);
    ...
    <div className="min-h-screen bg-hueso">
      ...
      <section id="catalogo" className="px-4 md:px-8 py-10 md:py-14 bg-verde">
        ...
        <div className="grid grid-cols-2 gap-2 max-w-4xl mx-auto">
          <Link
            href={`/catalogo?categoria=${encodeURIComponent(categorias[0].nombre)}`}
            className="relative rounded-lg overflow-hidden bg-verde-claro aspect-square cursor-pointer group"
            style={{
              backgroundImage: `url(${categorias[0].image})`,
          ...
          >
            ...
            <div className="absolute bottom-4 left-4">
              <h3 className="font text-base md:text-xl font-medium text-white">
                {categorias[0].nombre}
              </h3>
            ...
            {categorias.slice(1).map((cat, i) => (
              ...
              >
                ...
                <div className="absolute bottom-2 left-2 md:bottom-3 md:left-3">
                  <h3 className="font text-sm md:text-base font-medium text-white">
                    {cat.nombre}
                  </h3>
          ...
          <div className="relative overflow-hidden px-10 md:px-12">
            <div className="flex gap-4 md:gap-6">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="min-w-[calc(100%-16px)] md:min-w-[calc(33.333%-16px)] bg-white rounded-lg overflow-hidden border border-gray-100 flex-shrink-0 animate-pulse"
                >
            ...
            <div className="relative overflow-hidden px-10 md:px-12">
              ...
              >
                {destacados.map((producto, i) => {
                  ...
                  const imagenUrl =
                    producto.images?.find((img) => img.favorite)?.url ||
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <h3 className="text-sm font-medium text-verde mb-2 line-clamp-2">
                          {producto.name}
                        </h3>
              ...
              <button
                onClick={() =>
                  setSliderActual(
                    sliderActual === destacados.length - 1
                      ? 0
                      : sliderActual + 1,
                  )
                }
      ...
      <section
        id="filosofia"
        className="px-4 md:px-8 py-10 md:py-14 bg-hueso border-t border-gray-100"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <p className="text-base md:text-lg text-verde/90 leading-relaxed mb-8">
              En La Llave Del Norte, creemos que cada espacio y cada proyecto es
              una puerta hacia nuevas posibilidades. Nuestra misión es brindar
              las herramientas y la dirección necesarias para que nuestros
              clientes superen cualquier barrera.
            </p>
            <div className="flex gap-6 md:gap-8 mb-8">
              ...
              <div>
                <p className="text-2xl font-medium text-amarillo-oscuro">
                  185+
                </p>
                <p className="text-xs text-amarillo-oscuro uppercase tracking-wider mt-1">
