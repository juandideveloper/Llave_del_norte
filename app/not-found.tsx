...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-hueso flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            ...
            <g transform="translate(0.000000,321.000000) scale(0.100000,-0.100000)" fill="#112221" stroke="none">
...
120 -50 180 -81z"/>
        ...
        {/* 404 */}
        <h1 className="text-8xl font-bold text-verde mb-2">404</h1>
        <div className="w-16 h-1 bg-amarillo mx-auto mb-6 rounded-full"/>
        <h2 className="text-xl font-semibold text-verde mb-3">Página no encontrada</h2>
        <p className="text-sm text-gray-400 mb-8 leading-relaxed">
          La página que buscas no existe o fue movida. Vuelve al inicio y sigue explorando nuestro catálogo.
        </p>

        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/"
            className="px-6 py-3 bg-verde text-amarillo text-sm font-medium rounded-xl hover:opacity-90 transition-opacity">
            Volver al inicio
          </Link>
          <Link href="/catalogo"
            className="px-6 py-3 border border-verde text-verde text-sm font-medium rounded-xl hover:bg-verde hover:text-amarillo transition-colors">
            Ver catálogo
          </Link>
        </div>
