  ...
  return (
    <>
      <div className="text-center mb-6">
        ...
        <h1 className="text-2xl font-semibold text-hueso">Nueva contraseña</h1>
      ...
      <form onSubmit={handleNuevaPassword} className="space-y-4">
        ...
        <AnimatePresence>
          {error && (
            ...
            >
              <p className="text-red-600 text-sm font-medium text-center items-center">
                {error}
              </p>
            </motion.p>
          )}
...
export default function NuevaPasswordPage() {
  return (
    <div className="password-container min-h-screen flex items-center justify-center">
