  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4">
      ...
      <h1 className="text-2xl font-semibold text-amarillo-oscuro mb-2">
        {esContraentrega ? "¡Pedido confirmado!" : "¡Pago exitoso!"}
      </h1>
      <p className="text-md font-semibold text-amarillo-oscuro mb-4 text-center max-w-md">
        {esContraentrega
          ? "Tu pedido ha sido registrado. Pagarás al momento de la entrega."
      ...
      {esContraentrega && (
        <div className="flex items-center gap-2 px-4 py-2 rounded-lg text-xs mb-6 bg-yellow-50 text-yellow-700">
          ...
          Recuerda tener el dinero listo al momento de la entrega
        </div>
      )}
